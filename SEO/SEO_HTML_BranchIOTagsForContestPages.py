...
#
# Acceptance Criteria:
# 1) STATION Contest Page: Branch IO HTML meta tags should match the Station API
#
#    API                 | |    HTML
#    ---                 | |    ----
#    DISPLAY NAME        | |    MARKET
...
#    NAME                | |    STATION NAME
#
# 2) NATIONAL Contest page:
#    A) Should only have the station_name Branch IO HTML meta tag
...
# We only want to test the contest page urls from the json file
failures = StationBranchIOTest.baseTest(station_urls, "contest_url")
...
# We only want to test the contest page urls from the json file
failed_national_calls = NationalBranchIOTest.NationalBaseTest(national_page_urls, "contest_url")
