...
#
# Acceptance Criteria:
# 1) STATION Event Pages: Branch IO HTML meta tags should match the Station API
#
#    API                 | |    HTML
#    ---                 | |    ----
#    DISPLAY NAME        | |    MARKET
...
# We only want to test the event page urls from the json file
failures = StationBranchIOTest.baseTest(station_urls, "event_url")
...
# We only want to test the event page urls from the json file
failed_national_calls = NationalBranchIOTest.NationalBaseTest(national_page_urls, "event_url")
