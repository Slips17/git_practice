...
#
# Acceptance Criteria:
# 1) STATION Content Collection Pages: Branch IO HTML meta tags should match the Station API
#
#    API                 | |    HTML
#    ---                 | |    ----
#    DISPLAY NAME        | |    MARKET
...
# We only want to test the content collection urls from the json file
failures = StationBranchIOTest.baseTest(station_urls, "content_collection_url")
...
# We only want to test the content collection urls from the json file
failed_national_calls = NationalBranchIOTest.NationalBaseTest(national_page_urls, "content_collection_url")
...
print("\n-------CONTENT COLLECTION TEST RESULTS----------")
...
print("-------CONTENT COLLECTION TEST RESULTS----------\n\n")
