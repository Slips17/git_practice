...
#  This script is checking Station Primary and Secondary Section Front Pages
#
# Acceptance Criteria:
# 1) nmc:pid should be content=”sectionfront_<sectionfront name>"
# 2) nmc:tag should be content=”sectionfront, <sectionfront name>, <sectionfront secondary_name>”
#
# -------------------------------------------------------------------------------------------------
...
with open(LIBRARY_PATH + "/sectionFrontURLs.json") as file:
    sectionfront_urls = json.load(file)

# Run the test with the URLs - get the number of pages failed.
pages_failed = NMCTest.singleTest(sectionfront_urls)
