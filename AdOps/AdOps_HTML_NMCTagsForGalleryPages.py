...
#  This script is checking Gallery Pages
#
# Acceptance Criteria:
# 1) nmc:pid should be content=”vgallery_<headline>"
# 2) nmc:tag should be content=”vgallery, <sectionfront name>, <sectionfront secondary_name>”
#
# -------------------------------------------------------------------------------------------------
...
with open(LIBRARY_PATH + "/galleryURLs.json") as file:
    gallery_urls = json.load(file)

# Run the test with the URLs - get the number of pages failed.
pages_failed = NMCTest.singleTest(gallery_urls)
