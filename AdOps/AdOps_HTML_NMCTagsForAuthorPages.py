...
#  This script is checking Author Pages
#
# Acceptance Criteria:
# 1) nmc:pid should be content=”authors_<author name>"
# 2) nmc:tag should be content=”authors”
#
# -------------------------------------------------------------------------------------------------
...
with open(LIBRARY_PATH + "/authorUrls.json") as file:
    author_urls = json.load(file)

# Run the test with the URLs - get the number of pages failed.
pages_failed = NMCTest.singleTest(author_urls)
