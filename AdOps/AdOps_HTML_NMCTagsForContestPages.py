...
#  This script is checking Contest Pages
#
# Acceptance Criteria:
# 1) nmc:pid should be content=”contests_<headline>"
# 2) nmc:tag should be content=”contests”
#
# -------------------------------------------------------------------------------------------------
...
with open(LIBRARY_PATH + "/contestUrls.json") as file:
    contest_urls = json.load(file)

# Run the test with the URLs - get the number of pages failed.
pages_failed = NMCTest.singleTest(contest_urls)
